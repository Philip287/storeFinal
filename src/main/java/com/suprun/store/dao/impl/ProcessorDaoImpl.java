...
import com.suprun.store.dao.ProcessorDao;
...
public class ProcessorDaoImpl implements ProcessorDao {
    ...
    private static final String INSERT = """
            INSERT INTO processors(name, price, picture_path, description)
            VALUES(?, ?, ?, ?);
            """;
    ...
    private static final String SELECT_MULTIPLE_BY_ID = """
            SELECT name, price, picture_path, description
            FROM processors
            WHERE processor_id LIKE CONCAT('%', ?, '%') AND deleted <> 1
            ORDER BY processor_id
            LIMIT ?, ?;
            """;
    ...
    public static ProcessorDao getInstance() {
        if (instance == null) {
            instance = new ProcessorDaoImpl();
        }
        return instance;
    }

    @Override
    public long insert(Processor entity) throws DaoException {
    ...
    @Override
    public void update(Processor entity) throws DaoException {
    ...
    @Override
    public Optional<Processor> selectById(long id) throws DaoException {
        return QueryExecutor.createExecutor().executeSelect(SELECT_BY_ID, this, id);
    }

    @Override
    public List<Processor> selectById(int offset, int length, String keyword) throws DaoException {
    ...
    @Override
    public List<Processor> selectAll(int offset, int length) throws DaoException {
    ...
    @Override
    public List<Processor> selectByName(int offset, int length, String keyword) throws DaoException {
        return QueryExecutor.createExecutor()
    ...
    @Override
    public List<Processor> selectByPrice(int offset, int length, String keyword) throws DaoException {
        return QueryExecutor.createExecutor()
    ...
    @Override
    public List<Processor> selectByDescription(int offset, int length, String keyword) throws DaoException {
        return QueryExecutor.createExecutor()
    ...
    @Override
    public List<Processor> selectByPicturePath(int offset, int length, String keyword) throws DaoException {
        return QueryExecutor.createExecutor()
    ...
    @Override
    public Processor buildEntityFromResultSet(ResultSet resultSet) throws SQLException {
        return ProcessorDao.super.buildEntityFromResultSet(resultSet);
    }
